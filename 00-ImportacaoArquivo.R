...
# O dataset original está disponível em https://www.kaggle.com/c/talkingdata-adtracking-fraud-detection/data

# Se não quiser realizar todo o procedimento de divisão e amostragem do arquivo, pule para a ultima linha desse arquivo.
# O arquivo de amostragem utilizado nesse projeto está diponível nesse link: https://drive.google.com/file/d/1PxN_hSUEKfQxu_JqnyueR086fk5yWlzW/view?usp=sharing. 
# Se preferir utilizar o dataset completo ou fazer sua própria amostragem, o link para o kaggle está acima nesse arquivo.
